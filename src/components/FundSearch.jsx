    ...
    <div style={{ position: "relative", marginBottom: "12px" }}>
      <input type="text"
        ...
        style={{
          ...
          borderRadius: "8px", color: loading ? COLOR.text.secondary : COLOR.text.primary, fontSize: "13px",
          padding: "9px 14px", outline: "none", fontFamily: FONT.family.display,
        }}
      />
      ...
      {showDropdown && (
        <div style={{
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ fontSize: "13px", color: COLOR.text.primary, fontFamily: FONT.family.display }}>
                  {f.name}{f.isManual && <span style={{ fontSize: "10px", color: COLOR.text.secondary, marginLeft: "6px" }}>manuell</span>}
                </div>
                <div style={{ fontSize: "10px", color: COLOR.text.secondary, fontFamily: "monospace" }}>{f.isManual ? "" : f.ticker}</div>
              </div>
          ...
          >
            ...
            <span style={{ fontSize: "12px", color: COLOR.text.subtle, fontFamily: FONT.family.display }}>Lägg till fond manuellt</span>
          </div>
        </div>
      )}
      {showManualModal && (
